...
sys.path.append('/home/pengshijie/qitian/OCD/')
...
CONFIG_PATH = '/home/pengshijie/qitian/OCD/'
os.chdir(os.path.dirname(os.path.abspath(__file__)))

context = ssl.create_default_context(ssl.Purpose.CLIENT_AUTH)
context.load_cert_chain(f'{CONFIG_PATH}/hook/server.crt', f'{CONFIG_PATH}hook/server.key')
...
def schedule(pod):
    ...
    candidates = [c for c in candidates if c in node_list["3090"] + node_list["V100"]]
