...
with torch.inference_mode():
    model= torch.load('/data/model/openfaas/cdgp/wholegraphs/bert-21b//bert-21b-wholemod.pt', map_location=infer_device)
    # warm up 
    ...
    x = torch.load("/data/model/openfaas/cdgp/wholegraphs/bert-21b/bert-21b-wholemod-inputs.pt", map_location=infer_device)
    output = model(*x)
