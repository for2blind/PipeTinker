...
with torch.inference_mode():
    model= torch.load('/data/model/openfaas/cdgp/subgraphs/bert-21b/TIME_OAP/8/bert-21b-submod-7.pt', map_location=infer_device)
    # warm up 
    ...
    x = torch.load("/data/model/openfaas/cdgp/subgraphs/bert-21b/TIME_OAP/8/bert-21b-inputs-7.pt", map_location=infer_device)
    output = model(*x)
