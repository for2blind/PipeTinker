...
with torch.inference_mode():
    model= torch.load('/data/model/openfaas/cdgp/subgraphs/whisper-large-v2/ME_OAP/10.0-1/whisper-large-v2-submod-0.pt', map_location=infer_device)
    # warm up 
    ...
    x = torch.load("/data/model/openfaas/cdgp/subgraphs/whisper-large-v2/ME_OAP/10.0-1/whisper-large-v2-inputs-0.pt", map_location=infer_device)
    output = model(*x)
