...
with torch.inference_mode():
    model= torch.load('/data/model/openfaas/cdgp/subgraphs/whisper-large-v2/LATENCY_OAP/10.0-2/whisper-large-v2-submod-1.pt', map_location=infer_device)
    # warm up 
    ...
    x = torch.load("/data/model/openfaas/cdgp/subgraphs/whisper-large-v2/LATENCY_OAP/10.0-2/whisper-large-v2-inputs-1.pt", map_location=infer_device)
    output = model(*x)
