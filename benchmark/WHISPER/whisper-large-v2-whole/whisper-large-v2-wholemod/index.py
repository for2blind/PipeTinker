...
with torch.inference_mode():
    model= torch.load('/data/model/openfaas/cdgp/wholegraphs/whisper-large-v2//whisper-large-v2-wholemod.pt', map_location=infer_device)
    # warm up 
    ...
    x = torch.load("/data/model/openfaas/cdgp/wholegraphs/whisper-large-v2/whisper-large-v2-wholemod-inputs.pt", map_location=infer_device)
    output = model(*x)
