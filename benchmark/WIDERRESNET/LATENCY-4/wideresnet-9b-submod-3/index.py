...
with torch.inference_mode():
    model= torch.load('/data/model/openfaas/cdgp/subgraphs/wideresnet-9b/LATENCY_OAP/10.0-4/wideresnet-9b-submod-3.pt', map_location=infer_device)
    # warm up 
    ...
    x = torch.load("/data/model/openfaas/cdgp/subgraphs/wideresnet-9b/LATENCY_OAP/10.0-4/wideresnet-9b-inputs-3.pt", map_location=infer_device)
    output = model(*x)
