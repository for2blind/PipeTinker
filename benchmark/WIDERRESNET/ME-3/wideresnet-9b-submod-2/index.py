...
with torch.inference_mode():
    model= torch.load('/data/model/openfaas/cdgp/subgraphs/wideresnet-9b/ME_OAP/10.0-3/wideresnet-9b-submod-2.pt', map_location=infer_device)
    # warm up 
    ...
    x = torch.load("/data/model/openfaas/cdgp/subgraphs/wideresnet-9b/ME_OAP/10.0-3/wideresnet-9b-inputs-2.pt", map_location=infer_device)
    output = model(*x)
