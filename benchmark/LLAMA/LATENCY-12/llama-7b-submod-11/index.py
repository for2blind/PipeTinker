...
with torch.inference_mode():
    model= torch.load('/data/model/openfaas/cdgp/subgraphs/llama-7b/LATENCY_OAP/10.0-12/llama-7b-submod-11.pt', map_location=infer_device)
    # warm up 
    ...
    x = torch.load("/data/model/openfaas/cdgp/subgraphs/llama-7b/LATENCY_OAP/10.0-12/llama-7b-inputs-11.pt", map_location=infer_device)
    output = model(*x)
