...
with torch.inference_mode():
    model= torch.load('/data/model/openfaas/cdgp/subgraphs/llama-7b/ME_OAP/10.0-5/llama-7b-submod-4.pt', map_location=infer_device)
    # warm up 
    ...
    x = torch.load("/data/model/openfaas/cdgp/subgraphs/llama-7b/ME_OAP/10.0-5/llama-7b-inputs-4.pt", map_location=infer_device)
    output = model(*x)
