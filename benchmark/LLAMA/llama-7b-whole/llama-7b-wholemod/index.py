...
with torch.inference_mode():
    model= torch.load('/data/model/openfaas/cdgp/wholegraphs/llama-7b//llama-7b-wholemod.pt', map_location=infer_device)
    # warm up 
    ...
    x = torch.load("/data/model/openfaas/cdgp/wholegraphs/llama-7b/llama-7b-wholemod-inputs.pt", map_location=infer_device)
    output = model(*x)
