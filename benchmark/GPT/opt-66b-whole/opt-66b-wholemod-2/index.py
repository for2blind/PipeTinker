...
with torch.inference_mode():
    model= torch.load('/data/model/openfaas/cdgp/wholegraphs/opt-66b//opt-66b-wholemod-2.pt', map_location=infer_device)
    # warm up 
    ...
    x = torch.load("/data/model/openfaas/cdgp/wholegraphs/opt-66b/opt-66b-wholemod-inputs-2.pt", map_location=infer_device)
    output = model(*x)
